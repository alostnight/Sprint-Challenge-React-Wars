...
It's a cleaner and faster way to make an app using a interface library.

- [ ] What does it mean to _think_ in react?
It means to think in componenets and componenet hierarchies.

- [ ] Describe state.
It's the class and functional components that will be used to gather data.

- [ ] Describe props.
Props help with moving data from one file to another. 
